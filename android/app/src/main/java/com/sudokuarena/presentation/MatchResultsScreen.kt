...
private fun gameName(gameType: GameType): String = when (gameType) {
    ...
    GameType.TIC_TAC_TOE -> "El Gato"
    GameType.DOTS_AND_BOXES -> "Timbiriche"
    GameType.KAKURO -> "Kakuro"
    GameType.MATHDOKU -> "Mathdoku"
    GameType.HITORI -> "Hitori"
    GameType.CHESS_TACTICS -> "Chess Tactics RPG"
    GameType.NURIKABE -> "Nurikabe"
    GameType.BRIDGES -> "Bridges"
    GameType.TETRIS_ARENA -> "Tetris Arena"
    GameType.HANGMAN -> "El Ahorcado"
    GameType.ARROWS_ESCAPE -> "Flechas en Fuga"
    GameType.PACMAN_ARENA -> "Pac-Man Arena"
